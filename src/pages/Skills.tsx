...
const hardSkills = [
  {
    ...
    icon: MdWeb,
    description: "Desenvolvimento de aplicações web usando HTML, CSS, JavaScript, React e outras tecnologias modernas.",
    level: 60,
  ...
  },
  {
    ...
    level: 80,
    context: "Tarefas diárias, desenvolvimento e estudo de segurança e novas tecnologias.",
  },
  {
    id: "kali",
    label: "Kali Linux",
...
const softSkills = [
  ...
  },
  {
    ...
    icon: FaSortAlphaUp,
    description: "Boa gestão de tempo, tarefas e prioridades com uso de ferramentas como Notion e Trello.",
    level: 80,
  ...
  return (
    <div className="min-h-screen text-white px-6 py-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray text-lg mb-12">
          Além do conhecimento técnico, também cultivo habilidades interpessoais e de desenvolvimento pessoal importantes no dia a dia profissional.
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
